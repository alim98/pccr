...
CONFIG_PATH="${CONFIG_PATH:-src/pccr/configs/pairwise_oasis_v4c.yaml}"
...
REAL_EXPERIMENT_NAME="${REAL_EXPERIMENT_NAME:-pccr_oasis_real_v4c_${RUN_TAG}}"
...
printf '[run_pccr_oasis_v4c.sh] Command:'
printf ' %q' "${CMD[@]}"
printf '\n'
