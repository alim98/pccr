...
CONFIG_PATH="${CONFIG_PATH:-src/pccr/configs/pairwise_oasis_vnext.yaml}"
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-pccr_vnext_overfit10_diag}"
...
CUDA_VISIBLE_DEVICES="${GPU_ID}" "${PYTHON_BIN}" src/pccr/scripts/train.py \
  ...
  --config_override decoder_fitting_weight=0.05 \
