...
CONFIG_PATH="${CONFIG_PATH:-src/pccr/configs/pairwise_oasis_v4d.yaml}"
...
REAL_EXPERIMENT_NAME="${REAL_EXPERIMENT_NAME:-pccr_oasis_real_v4d_${RUN_TAG}}"
...
printf '[run_pccr_oasis_v4d.sh] Command:'
printf ' %q' "${CMD[@]}"
printf '\n'
